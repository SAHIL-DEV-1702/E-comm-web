    ...
    <div className="w-full min-h-screen flex flex-col md:flex-row gap-10 p-10">
      ...
      <div className="md:w-1/2 flex flex-col justify-center items-center border rounded-2xl p-6">
        ...
        <div className='flex justify-center gap-10 mt-4 w-full'>
          <div className='hover:bg-gray-600 hover:hover:text-white text-xl font-bold text-gray-500 flex border-2 justify-center items-center p-2 rounded-2xl'>Add To Cart</div>

          <div className='hover:bg-gray-600 hover:text-white text-xl font-bold text-gray-500 flex border-2 justify-center items-center p-2 rounded-2xl'>Buy Now</div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
          ...
          {realtedProduct.map((item, idx) => (
            ...
            >
              ...
              <button className="w-full bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 transition active:scale-95">
                Add to Cart
              </button>
            </div>
          ))}
